...
PZGGameplayShootingRunner::PZGGameplayShootingRunner(){    
}

PZGGameplayShootingRunner::~PZGGameplayShootingRunner(){
}

PZGGameplayShootingRunner* PZGGameplayShootingRunner::createWithDictionary(ax::__Dictionary * dictionary){

    PZGGameplayShootingRunner *obj = new PZGGameplayShootingRunner();

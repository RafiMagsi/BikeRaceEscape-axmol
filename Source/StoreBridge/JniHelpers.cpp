...
void JniHelpers::jniCommonVoidCall(const char* methodName, const char* classPath) {
    ax::JniMethodInfo minfo;
    
    bool isHave = ax::JniHelper::getStaticMethodInfo(minfo,classPath,methodName, "()V"); 
...
void JniHelpers::jniCommonVoidCall(const char* methodName, const char* classPath, bool arg0) {
    ...
    bool isHave = ax::JniHelper::getStaticMethodInfo(minfo,classPath,methodName, "(Z)V"); 
...
void JniHelpers::jniCommonVoidCall(const char* methodName, const char* classPath, const char* arg0) 
    ...
    bool isHave = ax::JniHelper::getStaticMethodInfo(minfo, classPath, methodName, "(Ljava/lang/String;)V"); 
    ...
    if (!isHave) {
		...
		if(minfo.env->ExceptionCheck() == JNI_TRUE ) {
			...
			jclass vinfEx = ax::JniHelper::getClassID("com/soomla/store/exceptions/VirtualItemNotFoundException", minfo.env);
			...
			vinfEx = ax::JniHelper::getClassID("com/soomla/store/exceptions/NotEnoughGoodsException", minfo.env);
			if (minfo.env->IsInstanceOf(exceptionObj, vinfEx)) {
			...
			vinfEx = ax::JniHelper::getClassID("com/soomla/store/exceptions/InsufficientFundsException", minfo.env);
			if (minfo.env->IsInstanceOf(exceptionObj, vinfEx)) {
...
int JniHelpers::jniCommonIntCall(const char* methodName, const char* classPath, const char* arg0) 
    ...
    bool isHave = ax::JniHelper::getStaticMethodInfo(minfo,classPath,methodName, "(Ljava/lang/String;)I"); 
...
int JniHelpers::jniCommonIntCall(const char* methodName, const char* classPath, const char* arg0, int arg1) 
    ...
    bool isHave = ax::JniHelper::getStaticMethodInfo(minfo,classPath,methodName, "(Ljava/lang/String;I)I"); 
...
int JniHelpers::jniCommonIntCall(const char* methodName, const char* classPath, const char* arg0, const char* arg1) 
    ...
    bool isHave = ax::JniHelper::getStaticMethodInfo(minfo,classPath,methodName, "(Ljava/lang/String;Ljava/lang/String;)I"); 
...
string JniHelpers::jniCommonStringCall(const char* methodName, const char* classPath, const char* arg0) 
    ...
    bool isHave = ax::JniHelper::getStaticMethodInfo(minfo,classPath,methodName, "(Ljava/lang/String;)Ljava/lang/String;"); 
...
double JniHelpers::jniCommonDoubleCall(const char* methodName, const char* classPath, const char* arg0) 
    ...
    bool isHave = ax::JniHelper::getStaticMethodInfo(minfo,classPath,methodName, "(Ljava/lang/String;)D"); 

if(APPLE)
  ...
  if(DEFINED PZ_BUNDLE_ID)
    set_xcode_property(${APP_NAME} PRODUCT_BUNDLE_IDENTIFIER "${PZ_BUNDLE_ID}")
  endif()
  ...
  # Ensure embedded frameworks are discoverable.
  set_xcode_property(${APP_NAME} LD_RUNPATH_SEARCH_PATHS "@executable_path/Frameworks" "All")

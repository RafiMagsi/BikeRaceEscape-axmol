if(ANDROID)
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/proj.android/app/jni/main.cpp")
    list(APPEND GAME_SOURCE
      proj.android/app/jni/main.cpp
    )
  endif()
elseif(LINUX)
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/proj.linux/main.cpp")
    list(APPEND GAME_SOURCE
      proj.linux/main.cpp
    )
  endif()
...
elseif(WASM)
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/proj.wasm/main.cpp")
    list(APPEND GAME_SOURCE
      proj.wasm/main.cpp
    )
  endif()
...
elseif(WINDOWS)
  if(NOT WINRT)
    if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/proj.win32/main.cpp")
